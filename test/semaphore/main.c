...
#if FOUNDATION_PLATFORM_LINUX || FOUNDATION_PLATFORM_BSD || FOUNDATION_PLATFORM_ANDROID
...
#if FOUNDATION_PLATFORM_POSIX && !FOUNDATION_PLATFORM_IOS && !FOUNDATION_PLATFORM_PNACL
