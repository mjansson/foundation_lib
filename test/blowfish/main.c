...
#define NUM_VARIABLEKEYTESTS 34
#define NUM_SETKEYTESTS      24

static const uint32_t _test_plaintext_left[NUM_VARIABLEKEYTESTS + NUM_SETKEYTESTS] = {
...
static const uint32_t _test_plaintext_right[NUM_VARIABLEKEYTESTS + NUM_SETKEYTESTS] = {
...
static const unsigned char _test_key_variable[NUM_VARIABLEKEYTESTS][8] = {
...
static const unsigned char _test_key_set[24] = {
   0xF0, 0xE1, 0xD2, 0xC3, 0xB4, 0xA5, 0x96, 0x87,
   0x78, 0x69, 0x5A, 0x4B, 0x3C, 0x2D, 0x1E, 0x0F,
   0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77 };

static const uint32_t _test_ciphertext_left[NUM_VARIABLEKEYTESTS + NUM_SETKEYTESTS] = {
...
static const uint32_t _test_ciphertext_right[NUM_VARIABLEKEYTESTS + NUM_SETKEYTESTS] = {
...
static application_t test_blowfish_application( void )
{
    ...
    app.config_dir = string_const( STRING_CONST( "test_blowfish" ) );
