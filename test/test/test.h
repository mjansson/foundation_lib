...
#define EXPECT_REALEQ( var, expect ) do { if( !math_realeq( (var), (expect), 10 ) ) { log_warnf( WARNING_SUSPICIOUS, "Test failed, %s != %s real (at %s:%u)", FOUNDATION_PREPROCESSOR_TOSTRING(var), __FILE__, __LINE__ ); return -1; } } while(0)
