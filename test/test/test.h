...
#define EXPECT_REALZERO( var ) do { if( !math_real_is_zero(var) ) { log_warnf( HASH_TEST, WARNING_SUSPICIOUS, STRING_CONST( "Test failed, %s is not zero real (at %s:%u): %.6" PRIREAL ), FOUNDATION_PREPROCESSOR_TOSTRING(var), __FILE__, __LINE__, (real)((var)) ); RETURN_FAILED_TEST; } } while(0)
#define EXPECT_REALEPSILONZERO( var ) do { if( !math_real_is_epsilon_zero(var) ) { log_warnf( HASH_TEST, WARNING_SUSPICIOUS, STRING_CONST( "Test failed, %s is not zero real (at %s:%u): %.6" PRIREAL ), FOUNDATION_PREPROCESSOR_TOSTRING(var), __FILE__, __LINE__, (real)((var)) ); RETURN_FAILED_TEST; } } while(0)
#define EXPECT_REALONE( var ) do { if( !math_real_is_one(var) ) { log_warnf( HASH_TEST, WARNING_SUSPICIOUS, STRING_CONST( "Test failed, %s is not one real (at %s:%u): %.6" PRIREAL ), FOUNDATION_PREPROCESSOR_TOSTRING(var), __FILE__, __LINE__, (real)((var)) ); RETURN_FAILED_TEST; } } while(0)
#define EXPECT_REALNE( var, expect ) do { if( math_real_eq( (var), (expect), 10 ) ) { log_warnf( HASH_TEST, WARNING_SUSPICIOUS, STRING_CONST( "Test failed, %s == %s real (at %s:%u): %.6" PRIREAL " : %.6" PRIREAL ), FOUNDATION_PREPROCESSOR_TOSTRING(var), FOUNDATION_PREPROCESSOR_TOSTRING(expect), __FILE__, __LINE__, (real)((var)), (real)((expect)) ); RETURN_FAILED_TEST; } } while(0)
#define EXPECT_REALEQ( var, expect ) do { if( !math_real_eq( (var), (expect), 10 ) ) { log_warnf( HASH_TEST, WARNING_SUSPICIOUS, STRING_CONST( "Test failed, %s != %s real (at %s:%u): %.6" PRIREAL " : %.6" PRIREAL ), FOUNDATION_PREPROCESSOR_TOSTRING(var), FOUNDATION_PREPROCESSOR_TOSTRING(expect), __FILE__, __LINE__, (real)((var)), (real)((expect)) ); RETURN_FAILED_TEST; } } while(0)
