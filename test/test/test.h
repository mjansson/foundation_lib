...
#define EXPECT_STREQ( var, expect ) do { if( !string_equal( (var), (expect) ) ) { log_warnf( HASH_TEST, WARNING_SUSPICIOUS, STRING_CONST( "Test failed, %s != %s ('%s', '%s') (at %s:%u)" ), FOUNDATION_PREPROCESSOR_TOSTRING(var), FOUNDATION_PREPROCESSOR_TOSTRING(expect), (var), (expect), __FILE__, __LINE__ ); RETURN_FAILED_TEST; } } while(0)
#define EXPECT_STREQ_SUBSTR( var, expect, length ) do { if( !string_equal_substr( (var), (expect), (length) ) ) { log_warnf( HASH_TEST, WARNING_SUSPICIOUS, STRING_CONST( "Test failed, %s != %s for length %d ('%.*s', '%.*s') (at %s:%u)" ), FOUNDATION_PREPROCESSOR_TOSTRING(var), FOUNDATION_PREPROCESSOR_TOSTRING(expect), (int)(length), (int)(length), (var), (int)(length), (expect), __FILE__, __LINE__ ); RETURN_FAILED_TEST; } } while(0)

#define EXPECT_STREQ_MSG( var, expect, msg ) do { if( !string_equal( (var), (expect) ) ) { log_warnf( HASH_TEST, WARNING_SUSPICIOUS, STRING_CONST( "Test failed, %s != %s ('%s', '%s') (at %s:%u) : %s" ), FOUNDATION_PREPROCESSOR_TOSTRING(var), FOUNDATION_PREPROCESSOR_TOSTRING(expect), (var), (expect), __FILE__, __LINE__, msg ); RETURN_FAILED_TEST; } } while(0)
#define EXPECT_STREQ_SUBSTR_MSG( var, expect, length, msg ) do { if( !string_equal_substr( (var), (expect), (length) ) ) { log_warnf( HASH_TEST, WARNING_SUSPICIOUS, STRING_CONST( "Test failed, %s != %s for length %d ('%.*s', '%.*s') (at %s:%u) : %s" ), FOUNDATION_PREPROCESSOR_TOSTRING(var), FOUNDATION_PREPROCESSOR_TOSTRING(expect), (int)(length), (int)(length), (var), (int)(length), (expect), __FILE__, __LINE__, msg ); RETURN_FAILED_TEST; } } while(0)

#define EXPECT_STREQ_MSGFORMAT( var, expect, format, ... ) do { if( !string_equal( (var), (expect) ) ) { log_warnf( HASH_TEST, WARNING_SUSPICIOUS, STRING_CONST( "Test failed, %s != %s ('%s', '%s') (at %s:%u) : " format ), FOUNDATION_PREPROCESSOR_TOSTRING(var), FOUNDATION_PREPROCESSOR_TOSTRING(expect), (var), (expect), __FILE__, __LINE__, __VA_ARGS__ ); RETURN_FAILED_TEST; } } while(0)
#define EXPECT_STREQ_SUBSTR_MSGFORMAT( var, expect, length, format, ... ) do { if( !string_equal_substr( (var), (expect), (length) ) ) { log_warnf( HASH_TEST, WARNING_SUSPICIOUS, STRING_CONST( "Test failed, %s != %s for length %d ('%.*s', '%.*s') (at %s:%u) : " format ), FOUNDATION_PREPROCESSOR_TOSTRING(var), FOUNDATION_PREPROCESSOR_TOSTRING(expect), (int)(length), (int)(length), (var), (int)(length), (expect), __FILE__, __LINE__, __VA_ARGS__ ); RETURN_FAILED_TEST; } } while(0)
