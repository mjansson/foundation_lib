...
#define EXPECT_STRINGEQ( var, expect ) do { if( !string_equal( STRING_ARGS( (var) ), STRING_ARGS( (expect) ) ) ) { log_warnf( HASH_TEST, WARNING_SUSPICIOUS, STRING_CONST( "Test failed, %s != %s ('%.*s', '%.*s') (at %s:%u)" ), FOUNDATION_PREPROCESSOR_TOSTRING(var), FOUNDATION_PREPROCESSOR_TOSTRING(expect), STRING_FORMAT( (var) ), STRING_FORMAT( (expect) ), __FILE__, __LINE__ ); RETURN_FAILED_TEST; } } while(0)
#define EXPECT_STRINGEQ_MSG( var, expect, msg ) do { if( !string_equal( STRING_ARGS( (var) ), STRING_ARGS( (expect) ) ) ) { log_warnf( HASH_TEST, WARNING_SUSPICIOUS, STRING_CONST( "Test failed, %s != %s ('%s', '%s') (at %s:%u) : %s" ), FOUNDATION_PREPROCESSOR_TOSTRING(var), FOUNDATION_PREPROCESSOR_TOSTRING(expect), STRING_FORMAT( (var) ), STRING_FORMAT( (expect) ), __FILE__, __LINE__, msg ); RETURN_FAILED_TEST; } } while(0)
#define EXPECT_STRINGEQ_MSGFORMAT( var, expect, format, ... ) do { if( !string_equal( STRING_ARGS( (var) ), STRING_ARGS( (expect) ) ) ) { log_warnf( HASH_TEST, WARNING_SUSPICIOUS, STRING_CONST( "Test failed, %s != %s ('%s', '%s') (at %s:%u) : " format ), FOUNDATION_PREPROCESSOR_TOSTRING(var), FOUNDATION_PREPROCESSOR_TOSTRING(expect), STRING_FORMAT( (var) ), STRING_FORMAT( (expect) ), __FILE__, __LINE__, __VA_ARGS__ ); RETURN_FAILED_TEST; } } while(0)

#define EXPECT_STRINGNE( var, expect ) do { if( string_equal( STRING_ARGS( (var) ), STRING_ARGS( (expect) ) ) ) { log_warnf( HASH_TEST, WARNING_SUSPICIOUS, STRING_CONST( "Test failed, %s == %s ('%.*s', '%.*s') (at %s:%u)" ), FOUNDATION_PREPROCESSOR_TOSTRING(var), FOUNDATION_PREPROCESSOR_TOSTRING(expect), STRING_FORMAT( (var) ), STRING_FORMAT( (expect) ), __FILE__, __LINE__ ); RETURN_FAILED_TEST; } } while(0)
#define EXPECT_STRINGNE_MSG( var, expect, msg ) do { if( string_equal( STRING_ARGS( (var) ), STRING_ARGS( (expect) ) ) ) { log_warnf( HASH_TEST, WARNING_SUSPICIOUS, STRING_CONST( "Test failed, %s == %s ('%s', '%s') (at %s:%u) : %s" ), FOUNDATION_PREPROCESSOR_TOSTRING(var), FOUNDATION_PREPROCESSOR_TOSTRING(expect), STRING_FORMAT( (var) ), STRING_FORMAT( (expect) ), __FILE__, __LINE__, msg ); RETURN_FAILED_TEST; } } while(0)
#define EXPECT_STRINGNE_MSGFORMAT( var, expect, format, ... ) do { if( string_equal( STRING_ARGS( (var) ), STRING_ARGS( (expect) ) ) ) { log_warnf( HASH_TEST, WARNING_SUSPICIOUS, STRING_CONST( "Test failed, %s == %s ('%s', '%s') (at %s:%u) : " format ), FOUNDATION_PREPROCESSOR_TOSTRING(var), FOUNDATION_PREPROCESSOR_TOSTRING(expect), STRING_FORMAT( (var) ), STRING_FORMAT( (expect) ), __FILE__, __LINE__, __VA_ARGS__ ); RETURN_FAILED_TEST; } } while(0)
