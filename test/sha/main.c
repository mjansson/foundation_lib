...
DECLARE_TEST(sha, reference) {
	...
	sha256_digest(sha, STRING_CONST(""));
	sha256_digest_finalize(sha);
	...
	sha256_digest(sha, STRING_CONST("t"));
	sha256_digest_finalize(sha);
	...
	sha256_digest(sha, STRING_CONST("testing sha implementation"));
	sha256_digest_finalize(sha);
	...
	sha256_digest(sha, STRING_CONST("testing sha implementation"));
	sha256_digest(sha, STRING_CONST(""));
	sha256_digest(sha, STRING_CONST("further testing sha implementation with long buffer > 32 bytes"));
	sha256_digest_finalize(sha);
	digest = sha256_get_digest(sha, shastr, sizeof(shastr));
	...
	sha256_digest(sha, STRING_CONST(""));
	sha256_digest(sha, STRING_CONST("ong, which should trigger the edge case of buffer padding."));
	sha256_digest_finalize(sha);
	digest = sha256_get_digest(sha, shastr, sizeof(shastr));
	...
	sha256_digest(sha, digest_test_string, 2000);
	sha256_digest_finalize(sha);
	digest = sha256_get_digest(sha, shastr, sizeof(shastr));
