/* main.c  -  Foundation SHA-2 test  -  Public Domain  -  2013 Mattias Jansson / Rampant Pixels
 *
...
test_sha_application(void) {
	...
	app.config_dir = string_const(STRING_CONST("test_sha"));
...
DECLARE_TEST(sha, reference) {
	...
	EXPECT_STRINGEQ(digest, string_const(
	                    STRING_CONST("e3b98a4da31a127d4bde6e43033f66ba274cab0eb7eb1c70ec41402bf6273dd8")));
	...
	EXPECT_STRINGEQ(digest, string_const(
	                    STRING_CONST("996b42ec51535716079323ae099876d25c5d34a13c529bab5cf0e69613d92163")));

	sha256_digest(sha256, STRING_CONST("testing sha implementation"));
	sha256_digest(sha256, STRING_CONST(""));
	sha256_digest(sha256,
	              STRING_CONST("further testing sha implementation with long buffer > 32 bytes"));
	sha256_digest_finalize(sha256);
	digest = sha256_get_digest(sha256, shastr, sizeof(shastr));

	EXPECT_STRINGEQ(digest, string_const(
	                    STRING_CONST("1c282ea87da44b562e7d737ce67f6286f10431ae23c96114ffea6f108617bdac")));

	sha256_digest(sha256,
	              STRING_CONST("testing sha implementation with a buffer that is 64 + 58 bytes l"));
	sha256_digest(sha256, STRING_CONST(""));
	...
	EXPECT_STRINGEQ(digest, string_const(
	                    STRING_CONST("546cb96d98f9e20fb6cbbcbf2ca215d793ecb1f98bc19d458e8d5460e249f769")));
	...
	EXPECT_STRINGEQ(digest, string_const(
	                    STRING_CONST("7c0b7113a3e5a156d60e858da92a11a1fcdb11e7626482179f0a3ded5ef33a75")));
	...
	EXPECT_STRINGEQ(digest, string_const(
	                    STRING_CONST("99f97d455d5d62b24f3a942a1abc3fa8863fc0ce2037f52f09bd785b22b800d4f2e7b2b614cb600ffc2a4fe24679845b24886d69bb776fcfa46e54d188889c6f")));
	...
	EXPECT_STRINGEQ(digest, string_const(
	                    STRING_CONST("8a6b756216f93dd17352b64984c1ea25d6d4be8ffd284c679d7f2f04c956c7e015f0c770260a607a4ba94ef46ef7f68a3e47c79d400d1bf0d9ce3e1862663805")));
	...
	EXPECT_STRINGEQ(digest, string_const(
	                    STRING_CONST("a150934b8be284a8a417196e3ddb6402fcdcecedcbeedd7ca5eb1a7603b170e98f4b08786967f50aa5912b0cdbc64dc78a39ddc9f2bc52c438f1570601c8e73d")));

	sha512_digest(sha512,
	              STRING_CONST("testing sha implementation with a buffer that is 128 + 114 bytes l"));
	sha512_digest(sha512, STRING_CONST(""));
	sha512_digest(sha512, STRING_CONST("ong, which should trigger the edge case of buffer padding. Fill with nonsense. "));
	sha512_digest(sha512, STRING_CONST("Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut lab"));
	sha512_digest_finalize(sha512);
	digest = sha512_get_digest(sha512, shastr, sizeof(shastr));

	EXPECT_STRINGEQ(digest, string_const(
	                    STRING_CONST("c752654931621ac2eaf8aef597000403b6f6d40c3cc4f18ad579bea7a586857381935657fe6470b7bf729b36af4581207d096851d7bec7d972cd61dfef78eb7a")));
	...
	EXPECT_STRINGEQ(digest, string_const(
	                    STRING_CONST("4f85e6e923f5b173002a0edbd99f0bdafa8ddbe8653c19323b087ac772b36d1c61da24adf5bf91f771057e039fbefc63814d14bc4ad6ad4acd996ccdfa6f954d")));
...
static test_suite_t test_sha_suite = {
	test_sha_application,
