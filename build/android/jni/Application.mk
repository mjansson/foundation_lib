...
APP_MODULES      := test-all test-app test-array test-atomic test-base64 test-blowfish test-bufferstream test-config test-crash test-environment test-error test-event test-fs test-hash test-hashmap test-hashtable test-library test-math test-md5 test-mutex test-objectmap test-path test-radixsort test-random test-regex test-ringbuffer test-semaphore test-stacktrace test-string
