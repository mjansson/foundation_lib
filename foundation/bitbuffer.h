...
FOUNDATION_API void               bitbuffer_initialize( bitbuffer_t* bitbuffer, void* buffer, unsigned int size, bool swap );
...
/*! Align input to next even 32-bit boundary. Any pending bit data is
