...
FOUNDATION_API void            blowfish_initialize( blowfish_t* blowfish, const void* key, const unsigned int len );
FOUNDATION_API void            blowfish_reset( blowfish_t* blowfish );
