...
FOUNDATION_API void             hashtable32_initialize( hashtable32_t* table, size_t buckets );
...
FOUNDATION_API void             hashtable64_initialize( hashtable64_t* table, size_t buckets );
