...
#define error_context_string( str, length )   _error_context_string( str, length )
...
FOUNDATION_API string_t                       _error_context_string( char* str, size_t length );
...
#define error_context_string( str, length )   (void)sizeof( str ); (void)sizeof( length ), string_null()
