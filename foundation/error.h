...
#define error_context_string( str )           _error_context_string( str )
...
FOUNDATION_API string_t                       _error_context_string( string_t str );
...
#define error_context_str( str )              string_resize( str, 0, 0 )
