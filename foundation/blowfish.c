...
static const uint32_t _blowfish_sboxes_init[SBOXES][SBOXENTRIES] = {
{
	...
	0x53B02D5DU, 0xA99F8FA1U, 0x08BA4799U, 0x6E85076AL
},
{
	...
	0x153E21E7U, 0x8FB03D4AU, 0xE6E39F2BU, 0xDB83ADF7L
},
{
	...
	0xD79A3234U, 0x92638212U, 0x670EFA8EU, 0x406000E0L
},
{
	...
	0xB74E6132U, 0xCE77E25BU, 0x578FDFE3U, 0x3AC372E6L
}
};
...
void _blowfish_encrypt_words( const blowfish_t* blowfish, uint32_t* lvalres, uint32_t* hvalres )
{
	...
	hval ^= FEISTEL( lval ) ^ blowfish->parray[1];  lval ^= FEISTEL( hval ) ^ blowfish->parray[2];
	hval ^= FEISTEL( lval ) ^ blowfish->parray[3];  lval ^= FEISTEL( hval ) ^ blowfish->parray[4];
	hval ^= FEISTEL( lval ) ^ blowfish->parray[5];  lval ^= FEISTEL( hval ) ^ blowfish->parray[6];
	hval ^= FEISTEL( lval ) ^ blowfish->parray[7];  lval ^= FEISTEL( hval ) ^ blowfish->parray[8];
	hval ^= FEISTEL( lval ) ^ blowfish->parray[9];  lval ^= FEISTEL( hval ) ^ blowfish->parray[10];
	hval ^= FEISTEL( lval ) ^ blowfish->parray[11]; lval ^= FEISTEL( hval ) ^ blowfish->parray[12];
	hval ^= FEISTEL( lval ) ^ blowfish->parray[13]; lval ^= FEISTEL( hval ) ^ blowfish->parray[14];
	hval ^= FEISTEL( lval ) ^ blowfish->parray[15]; lval ^= FEISTEL( hval ) ^ blowfish->parray[16];
...
void _blowfish_decrypt_words( const blowfish_t* blowfish, uint32_t* lvalres, uint32_t* hvalres )
{
	...
	hval ^= FEISTEL( lval ) ^ blowfish->parray[16]; lval ^= FEISTEL( hval ) ^ blowfish->parray[15];
	hval ^= FEISTEL( lval ) ^ blowfish->parray[14]; lval ^= FEISTEL( hval ) ^ blowfish->parray[13];
	hval ^= FEISTEL( lval ) ^ blowfish->parray[12]; lval ^= FEISTEL( hval ) ^ blowfish->parray[11];
	hval ^= FEISTEL( lval ) ^ blowfish->parray[10]; lval ^= FEISTEL( hval ) ^ blowfish->parray[9];
	hval ^= FEISTEL( lval ) ^ blowfish->parray[8];  lval ^= FEISTEL( hval ) ^ blowfish->parray[7];
	hval ^= FEISTEL( lval ) ^ blowfish->parray[6];  lval ^= FEISTEL( hval ) ^ blowfish->parray[5];
	hval ^= FEISTEL( lval ) ^ blowfish->parray[4];  lval ^= FEISTEL( hval ) ^ blowfish->parray[3];
	hval ^= FEISTEL( lval ) ^ blowfish->parray[2];  lval ^= FEISTEL( hval ) ^ blowfish->parray[1];
