...
/*! \brief Post event
Post event to stream. This operation is thread-safe and will spin loop until operation can
...
/*! \brief Post event
Post event to stream with multiple payload fragments. Each fragment must be a pointer and
size pair of arguments, and terminated with a null pointer sentinel argument. This
operation is thread-safe and will spin loop until operation can be completed if in
