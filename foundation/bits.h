...
static FOUNDATION_FORCEINLINE FOUNDATION_PURECALL  void      byteorder_swap( void* buffer, const size_t size );
...
static FOUNDATION_FORCEINLINE FOUNDATION_PURECALL  void      byteorder_bigendian( void* buffer, const size_t size );
...
static FOUNDATION_FORCEINLINE FOUNDATION_PURECALL  void      byteorder_littleendian( void* buffer, const size_t size );
