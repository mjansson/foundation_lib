...
static size_t
_regex_parse_group(regex_t** target, const char* pattern, size_t offset, size_t length,
                   bool allow_grow) {
...
static size_t
_regex_parse(regex_t** target, const char* pattern, size_t offset, size_t length, bool allow_grow,
             size_t level) {
	size_t ret = 0;
